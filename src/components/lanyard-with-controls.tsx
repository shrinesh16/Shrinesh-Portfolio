          ...
          <div className="mb-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-2 p-3 border border-border rounded-md bg-muted/30">
                <label htmlFor="card-image" className="text-sm font-medium text-foreground cursor-pointer">
                  Upload Card Image
                </label>
                <input
                  id="card-image"
                  ...
                  className="text-sm text-muted-foreground file:mr-2 file:py-1 file:px-2 file:rounded file:border file:border-border file:text-xs file:font-medium file:bg-muted hover:file:bg-muted/80"
                />
                {cardImageUrl && (
