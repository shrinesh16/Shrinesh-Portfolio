...
const cardGLB = `${import.meta.env.BASE_URL}card2.0.glb`;
                    ...
                    >
                        <mesh geometry={nodes.card.geometry}>
                            <meshPhysicalMaterial
                                map={cardTextureUrl && customCardTexture ? customCardTexture : (materials.base || materials['front.001'])?.map}
                                map-anisotropy={16}
                        ...
                        <mesh geometry={nodes.clip.geometry} material={materials.metal || materials['metal.001']} material-roughness={0.3}/>
                        <mesh geometry={nodes.clamp.geometry} material={materials.metal || materials['metal.001']}/>
                    </group>
                </RigidBody>
            </group>
            <mesh ref={band}>
